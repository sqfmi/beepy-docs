...
export default function Hello() {
  return (
    <Layout title="Gallery" description="Beepberry Gallery">
        <section>
        ...
        <iframe loading="lazy" title="Beepberry - gomuks demo" src="https://www.youtube.com/embed/fIgzybDcvYk?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>
        </div>
        </section>
    </Layout>
  );
